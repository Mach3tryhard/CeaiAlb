...
\newcommand{\placelastupdatedtext}{% \placetextbox{<horizontal pos>}{<vertical pos>}{<stuff>}
  \AddToShipoutPictureFG*{% Add <stuff> to current page foreground
    \put(
        ...
        \small\color{gray}\textit{Last updated in Octobre 2024}\hspace{\widthof{Last updated in September 2024}}
    }}}%
  }%
}%
...
\begin{document}
    ...
    \begin{header}
        ...
        \AND%
        \kern 0.25 cm%
        \mbox{\hrefWithoutArrow{https://mach3tryhard.github.io/}{{\footnotesize\faLink}\hspace*{0.13cm}www.mach3tryhard.github.io}}%
        \kern 0.25 cm%
        \AND%
        \kern 0.25 cm%
...
manner
    ...
    \vspace{0.2 cm}
        ...
        \begin{twocolentry}{
            \href{https://github.com/Mach3tryhard/Mach3tryhard.github.io}{My Website}
        }
