...
\begin{document}
    ...
    \begin{header}
        ...
        \AND%
        \kern 0.25 cm%
        \mbox{\hrefWithoutArrow{https://mach3tryhard.github.io/CeaiAlb/}{{\footnotesize\faLink}\hspace*{0.13cm}https://mach3tryhard.github.io/CeaiAlb/}}%
        \kern 0.25 cm%
        \AND%
        \kern 0.25 cm%
...
manner
    ...
    \vspace{0.2 cm}
        ...
        \begin{twocolentry}{
            \href{https://github.com/Mach3tryhard/CeaiAlb/tree/main/Site}{My Website}
        }
